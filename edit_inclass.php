...
$s = new StudentForm;
$responses = $s->edit_class_log_byid($_REQUEST['id']);

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	
	$logClassID = $_POST['logClassID'];
	unset($_POST['logClassID']);
	$data = $_POST;
	$table='class_log';
	$where = "logClassID = '$logClassID'";
	
	$response = $s->update_query($table, str_replace("'","`",$data), $where);
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control" name="StudentID" id="StudentID">
                <option>Select Student</option><?php 
      ...
      <div class="col-md-12">
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control"  placeholder="dd/mm/yy" id = "datepicker-17" name="InClassDate" value="<?=$responses['InClassDate']?>" />
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="form-group">
          ...
          <input type="hidden" name="logClassID" value="<?=$responses['logClassID']?>"  />
