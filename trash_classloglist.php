...
$query = "SELECT st.`StudentID`, `FirstName`, `LastName`, `Gender`, `City`, `Licence`,  `logClassID`, `InClassDate`, cl.`Location`, `Hours`, `Instructor` FROM class_log as cl left join `student_information` as st on `st`.`StudentID`= `cl`.`StudentID`  where cl.`isActive`=0  ORDER BY `cl`.`logClassID`  DESC";
$records_per_page = 50;
...
?>
  <tr align="center">
    ...
    <td>&nbsp;</td>
    <td><a href="action_page.php?mode=restore&form=classLog&id=<?php echo ($val['logClassID']);?>" onclick="return checkmode(5)" >
  ...
  <div class="col-sm-12 text-right">
   <div class="col-sm-7  text-left"><button class="btn btn-default btn-lg active" onclick="javascript: checkAll(this, <?php echo $total; ?> )">All</button> &nbsp; 
								...
								<a class="btn btn-default btn-lg active" href="javascript:void(0);" 
								    onclick="javascript: doCheckBoxAction(this, <?php echo $total; ?>, 'action_page.php?mode=selectedRestore&form=classLog&id=',5);" >
									<img src="images/recycle_03.png" border=0/>&nbsp;Restore All</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-lg active" href="javascript:void(0);" 
								    onclick="javascript: doCheckBoxAction(this, <?php echo $total; ?>, 'action_page.php?mode=selectedPDelete&form=classLog&id=', '1');" >
