...
class DbConn
{
    ...
    public function __construct()
    {
        ...
        try {
			...
			$this->conn = new PDO("mysql:host=localhost;dbname=drivingschool", 'root', '');
			//$this->conn = new PDO("mysql:host=localhost;dbname=valleydr_driving_dss", 'valleydr_valdss', 'oNK;7g^]yL4?');
