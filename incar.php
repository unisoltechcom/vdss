...
<div class="wrapper">
  ...
  <form class="form-horizontal" name="myForm"  action="" method="post" onsubmit="return validateForm(this);">
    <div class="row">
      <div class="col-md-12">
        <div class="col-sm-6">
       <div class="text-center"> Only those students appear in the drop-down who have not <br>completed the Car Log hours yet.<br><br></div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control" name="StudentID" id="StudentID">
                ...
                <?php
		  $response = $s->list_students_incar();
        ...
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control" id="School" name="Hours">
      ...
      <div class="col-md-12">
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control"  placeholder="dd/mm/yy" id = "datepicker-17" name="InCarDate" >
...
$("#StudentID").change(function(){
    ...
    $.post("ajaxcall.php", {StudentID: StudentID , classlog:'carlog' }, function(result){
