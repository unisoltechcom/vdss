    ...
    <div class="col-md-12">
      <form action="searchinstructor.php" method="post" enctype="multipart/form-data">
        <div class="form-group searchboxcenter">
          <div class="col-sm-9">
            <input name="search"  class="form-control" type="text" value="<?=@$_REQUEST['search'] ? $_REQUEST['search'] : ''; ?>"  style="width: 100%;" placeholder="Search By Name and Location..." />
          </div>
          <div class="col-sm-3">
...
if($total > 0 ) { ?>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bordernone">
    <tr>
      <td align="left" class="text-success"><strong>
        <?=$pager["total_records_found_text"]?>
        </strong></td>
      <td align="right" class="text-success" style="text-transform:none;"><?php 
...
?>
    <tr align="center">
      ...
      <td><a href="view_instructorlog.php?id=<?php echo $val['Ins_id']?>" border="0" ><img src="images/view.png" border="0" /></a></td>
      <td><a href="edit_instructor.php?id=<?php echo $val['Ins_id']?>" border="0" ><img src="images/edit.gif" border="0" /></a></td>
      <td><a href="action_page.php?mode=delete&form=ins&id=<?php echo ($val['Ins_id']);?>" onclick="return checkmode(3)" > <img src="images/delete.png" border="0" /></a></td>
    </tr>
    <?php $row_count ++; } ?>
  </table>
  <br />
  <div class="row">
    <div class="col-sm-12 text-right">
      <div class="col-sm-5  text-left">
        <button class="btn btn-default btn-lg active" onclick="javascript: checkAll(this, <?php echo $total; ?> )">All</button>
        &nbsp;
        ...
        &nbsp;&nbsp;&nbsp; <a class="btn btn-default btn-lg active" href="javascript:void(0);" 
								    onclick="javascript: doCheckBoxAction(this, <?php echo $total; ?>, 'action_page.php?mode=selectedDelete&form=ins&id=',4);" > <img src="images/deleteall.png" border=0/>&nbsp;Delete All</a>&nbsp;&nbsp;&nbsp; <a href="trash_instructorlist.php" class="btn btn-default btn-lg active"  >Trash</a> </div>
      <div class=""><a  href="javascript:void(0);" onclick="javascript: doCheckBoxAction(this, <?php echo $total; ?>, 'xcel/xcelsheet.php?tableid=Ins_id&tablename=Instructor_information&ids=',0);" title="student list"><button type="button" class="btn btn-default btn-lg active" >Export to Excel</button></a></div>
    </div>
  </div>
  <?php } else { ?>
  <br />
