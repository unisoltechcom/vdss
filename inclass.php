...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$response = $s->addClassLog(str_replace("'","`",$classdata));
	//$response = $s->addClassLog($classdata);
	if ($response == 'true') {
...
<div class="wrapper">
  ...
  <form class="form-horizontal" name="myForm"  action="" method="post" onsubmit="return validateForm(this);">
    <div class="row">
      <div class="col-md-12">
        <div class="col-sm-6">
      <div class="text-center"> Only those students appear in the drop-down who have not <br>completed the Class Log hours yet.<br><br></div>
 ...
 <?php 
		  ...
		  $response = $s->list_students_inclass();
      ...
      <div class="col-md-12">
        <div class="col-md-6 col-sm-6">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control"  placeholder="dd/mm/yy" id = "datepicker-17" name="InClassDate" >
        ...
        <div class="col-sm-6"><div id="remaininghrs"></div></div>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-12">
...
$("#StudentID").change(function(){
    ...
    $.post("ajaxcall.php", {StudentID: StudentID , classlog:'classlog' }, function(result){
		console.log(result.disable);
		if(result['disable']==2) {
			$(':input[type="submit"]').prop('disabled', true);
            $("#remaininghrs").html(result.msg);
			} else {$(':input[type="submit"]').prop('disabled', false);$("#remaininghrs").html(result.msg);} 
